...
import defaultChar from '../img/tyt.png'; // fallback 이미지
...
// CharacterSelectPage에서 navigate로 넘어오는 state 타입
...
const MainPage: React.FC = () => {
  ...
  const { teacher, teacherImage } = (location.state as LocationState) ?? {};

  // 선택된 캐릭터 이미지가 없으면 기본 이미지(tyt) 사용
  ...
  return (
    <MainPageContainer>
      ...
      <ProfileSection>
        <CharacterContainer>
          {/* CharacterSelectPage에서 선택한 캐릭터 이미지 */}
